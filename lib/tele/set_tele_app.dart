...
class TeleAppPage extends StatefulWidget {
  const TeleAppPage({super.key});

  @override
  State<TeleAppPage> createState() => _TeleAppPageState();
}

class _TeleAppPageState extends State<TeleAppPage> {
  @override
              ...
              child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) =>
                            TeleAppGame(id: widget.number), // Beauty 이미지에 대한 페이지
                      ),
                    );
                  },
